...
<head>
    ...
    <title>Edit Populasi Kandang | Puyuh.in</title>
    <!-- plugins:css -->
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                ...
                <div class="card-body d-flex flex-column">
                  <div class="wrapper">
                    <h4 class="card-title mb-0">Edit Populasi</h4>
                  ...
                  <form class="forms-sample" method="POST" action="{{ url('api/kandang')}}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Populasi">
                    </div>
                    <div class="form-group">
