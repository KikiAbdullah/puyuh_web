            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body d-flex flex-column">
                  <div class="wrapper">
                    <h4 class="card-title mb-0">Kas</h4>
                    <p>Form Kas</p>
                    <div class="mb-4" id="net-profit-legend"></div>
                  </div>
                  @foreach ($data_kas as $item)
                  <form class="forms-sample" method="POST" action="{{ url('/api/kas/'. $item['id']) }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control" name="kas_perbulan" id="kas_perbulan" value="{{ $item['kas_perbulan'] }}">
                      </div>
                    </div>
